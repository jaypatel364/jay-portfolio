...
export function ServiceFinalCta({ service }: { service: Service }) {
  ...
  return (
    ...
    >
      <div className="w-full bg-gradient-to-b from-muted/20 to-background py-20 md:py-28">
          ...
          >
            ...
            <div className="relative mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                Let&apos;s turn the difficult part of {service.title.toLowerCase()} into something
                you don&apos;t have to worry about — no pitch deck, just an honest conversation
