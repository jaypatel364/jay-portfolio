...
export function ContactPageSection({ className }: ContactPageSectionProps) {
  ...
  return (
    <section id="contact-form" className={cn("px-6 pb-10 pt-10 md:pb-14 md:pt-14", className)}>
      <div className="mx-auto max-w-6xl">
        <div className="grid items-start gap-10 lg:grid-cols-5 lg:gap-14">
          ...
          <motion.div
            ...
            className="rounded-2xl border border-border bg-card/50 p-6 backdrop-blur-sm sm:p-8 lg:col-span-3"
          >
