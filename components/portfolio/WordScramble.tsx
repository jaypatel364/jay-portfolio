...
import { X, Trophy, RotateCcw, ArrowRight, Mail, Shuffle } from "lucide-react";
...
const WORD_BANK = [
  "react","array","debug","query","state","props","async","fetch","build","cache",
  "token","route","class","style","input","event","modal","timer","store","stack",
  "queue","logic","proxy","clone","merge","parse","chunk","scope","block","hooks",
  "types","cloud","patch","draft","error","media","frame","pixel","layer","index",
  "model","agent","shape","tuple","union","enum","interface","component","function",
  "server","client","deploy","branch","commit","module","import","export",
];
            ...
            <AnimatePresence mode="wait">
              ...
              {phase === "idle" && (
                <motion.div key="idle" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                  ...
                  <motion.div animate={{ rotate: [0, 180, 0] }} transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                ...
                <motion.div key="game" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <motion.div
                      ...
                      animate={phase === "correct" ? { scale: [1, 1.08, 1], opacity: 1 } : { scale: 1, opacity: 1 }}
                      className={cn(
                    ...
                    >
                      {jumbled.toUpperCase().split("").map((ch, i) => (
                        <motion.span
                          key={i}
                    ...
                    {hint && (
                      <p className="text-[11px] text-muted-foreground">
                        Starts with <span className="font-bold text-primary">{word[0].toUpperCase()}</span>
                        {" · "}{word.length} letters
                      </p>
                    )}
                  </div>
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      phase === "correct" ? "border-emerald-500/40 bg-emerald-500/8" : "border-border/50",
                    )}
                  />
