...
import { X, Trophy, RotateCcw, Hash } from "lucide-react";
              ...
              {phase === "idle" && (
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground max-w-[260px]">
                    Solve the equation and pick the right answer before 3 seconds run out. Gets
                    harder as you score. Combos earn bonus points!
                  </p>
                  <motion.button
